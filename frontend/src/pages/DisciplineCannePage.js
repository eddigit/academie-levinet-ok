...
const DisciplineCannePage = () => {
  ...
  const discSubtitle = content?.disciplines?.canne?.subtitle || 'Art Martial Français';
  const discDescription = content?.disciplines?.canne?.description || "Méthode de self-défense utilisant la canne comme instrument de protection. Une discipline traditionnelle française adaptée aux situations modernes.";
  const discImage = content?.disciplines?.canne?.image || '';
  ...
  const benefits = [
    ...
    { icon: Users, title: 'Accessible à Tous', description: 'Particulièrement adapté aux seniors et personnes à mobilité réduite.' },
    { icon: Award, title: 'Tradition Française', description: 'Un art martial français authentique, modernisé pour la self-défense.' },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-oswald text-4xl font-bold text-text-primary uppercase mb-6 tracking-tight">
                Un Art <span className="text-accent">Ancestral</span>
              </h2>
              <p className="text-text-secondary font-manrope text-lg leading-relaxed mb-6">
                La Canne Défense est une méthode de self-défense basée sur l'utilisation de la canne 
                comme instrument de protection. Issue de la tradition française, elle a été modernisée 
                par l'Académie Jacques Levinet pour répondre aux besoins actuels de sécurité personnelle.
              </p>
              <p className="text-text-secondary font-manrope text-lg leading-relaxed mb-6">
              ...
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                ...
                <p className="text-text-secondary font-manrope">
                  "Transformer un objet du quotidien en instrument de protection efficace et légal."
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="aspect-video rounded-lg overflow-hidden border border-white/10">
                <div 
                  ...
                  data-placeholder="canne-defense-training"
                >
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-accent/20 to-secondary/20">
                    <span className="text-text-muted font-manrope text-sm text-center px-4">Photo Canne Défense à ajouter</span>
                  </div>
                </div>
              </div>
            </div>
